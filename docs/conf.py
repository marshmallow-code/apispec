...
version = release = restkit.__version__
...
man_pages = [
    ('index', 'restkit', u'restkit Documentation',
     [u'Steven Loria'], 1)
]
...
texinfo_documents = [
  ('index', 'restkit', u'restkit Documentation',
   u'Steven Loria', 'restkit', 'A toolkit for building RESTful APIs with webargs and marshmallow',
   ''),
]
